package com.qboxus.hugme.Video_Calling;
...
import com.qboxus.hugme.LiveStreaming.activities.LiveActivity;
import com.qboxus.hugme.R;
import com.qboxus.hugme.Shared_pref.SharedPrefrence;
import com.qboxus.hugme.Video_Calling.util.CameraCapturerCompat;
...
public class VideoActivity extends AppCompatActivity {
    ...
    public void do_action_on_status(){
        if(call_status.equals(Call_Pick)) {
            ...
            if(calling_status_txt!=null)
                calling_status_txt.setText("Ringing...");
        }
    ...
    protected void onStart() {
        ...
        if (room != null) {
            reconnectingProgressBar.setVisibility((room.getState() != Room.State.RECONNECTING) ?
                    View.GONE :
                    View.VISIBLE);
            videoStatusTextView.setText("Connected to " + caller_name);
        }
    ...
    private void addRemoteParticipant(RemoteParticipant remoteParticipant) {
        ...
        videoStatusTextView.setText(caller_name + " joined");
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnected(Room room) {
                ...
                videoStatusTextView.setText("Connected to " + caller_name);
                calling_status_txt.setText("Connected");
            ...
            public void onReconnecting(@NonNull Room room, @NonNull TwilioException twilioException) {
                videoStatusTextView.setText("Reconnecting to " +caller_name);
                calling_status_txt.setText("Reconnecting");
            ...
            public void onConnectFailure(Room room, TwilioException e) {
                ...
                calling_status_txt.setText("Disconnected");
                configureAudio(false);
                intializeUI();
            }
            ...
            public void onDisconnected(Room room, TwilioException e) {
                ...
                videoStatusTextView.setText("Disconnected from " +caller_name);
                reconnectingProgressBar.setVisibility(View.GONE);
    ...
    private RemoteParticipant.Listener remoteParticipantListener() {
        return new RemoteParticipant.Listener() {
            ...
            public void onAudioTrackPublished(RemoteParticipant remoteParticipant,
                ...
                videoStatusTextView.setText("Audio Connected");
            }
            ...
            public void onAudioTrackUnpublished(RemoteParticipant remoteParticipant,
                ...
                Log.i(TAG, String.format("onAudioTrackUnpublished: " +
                        ...
                        remoteAudioTrackPublication.isTrackSubscribed(),
                        remoteAudioTrackPublication.getTrackName()));
                videoStatusTextView.setText("Audio Unpublished");
            }
            ...
            public void onVideoTrackPublished(RemoteParticipant remoteParticipant,
                ...
                videoStatusTextView.setText("Video Connected");
            }
            ...
            public void onVideoTrackUnpublished(RemoteParticipant remoteParticipant,
                ...
                Log.i(TAG, String.format("onVideoTrackUnpublished: " +
                        ...
                        remoteVideoTrackPublication.isTrackSubscribed(),
                        remoteVideoTrackPublication.getTrackName()));
                videoStatusTextView.setText("Video Unpublished");
            }
            ...
            public void onAudioTrackSubscribed(RemoteParticipant remoteParticipant,
                ...
                videoStatusTextView.setText("Audio Subscribed");
            }
            ...
            public void onAudioTrackUnsubscribed(RemoteParticipant remoteParticipant,
                ...
                Log.i(TAG, String.format("onAudioTrackUnsubscribed: " +
                        ...
                        remoteAudioTrack.isPlaybackEnabled(),
                        remoteAudioTrack.getName()));
                videoStatusTextView.setText("Audio Unsubscribed");
            }
            ...
            public void onAudioTrackSubscriptionFailed(RemoteParticipant remoteParticipant,
                ...
                videoStatusTextView.setText("Audio SubscriptionFailed");
            }
            ...
            public void onVideoTrackSubscribed(RemoteParticipant remoteParticipant,
                ...
                videoStatusTextView.setText("Video Subscribed");
            ...
            public void onVideoTrackUnsubscribed(RemoteParticipant remoteParticipant,
                ...
                Log.i(TAG, String.format("onVideoTrackUnsubscribed: " +
                        ...
                        remoteVideoTrack.isEnabled(),
                        remoteVideoTrack.getName()));
                videoStatusTextView.setText("Video Unsubscribed");
            ...
            public void onVideoTrackSubscriptionFailed(RemoteParticipant remoteParticipant,
                ...
                Log.i(TAG, String.format("onVideoTrackSubscriptionFailed: " +
                        ...
                        twilioException.getCode(),
                        twilioException.getMessage()));
                videoStatusTextView.setText("Video Subscription Failed");
                Snackbar.make(connectActionFab,
    ...
    private void retrieveAccessTokenfromServer() {
        ...
        Log.d("resp", Api_Links.TWILIO_ACCESS_TOKEN_SERVER +identity+"?roomname="+roomname);
        StringRequest postRequest = new StringRequest(Request.Method.GET,
                Api_Links.TWILIO_ACCESS_TOKEN_SERVER +identity+"?roomname="+roomname,
    ...
    public void Send_notification(String call_status, String message){
        ...
        String name = Functions.get_info(VideoActivity.this,"first_name") + " " + Functions.get_info(VideoActivity.this,"last_name");
    ...
    public void Start_limit_Timer(){
        limit_countDownTimer= new CountDownTimer(Variables.max_video_calling_time, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                if(call_type.equals("video_call")) {
                    int call_time = SharedPrefrence.get_int(VideoActivity.this, SharedPrefrence.video_calling_used_time);
                    SharedPrefrence.save_int(VideoActivity.this, call_time + 1000, SharedPrefrence.video_calling_used_time);
                ...
                {
                    int call_time = SharedPrefrence.get_int(VideoActivity.this, SharedPrefrence.voice_calling_used_time);
                    SharedPrefrence.save_int(VideoActivity.this, call_time + 1000, SharedPrefrence.voice_calling_used_time);
